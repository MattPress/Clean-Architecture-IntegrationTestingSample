namespace IntegrationTestingSample.UnitTests.EntitiesTests
{
    using System;
    ...
    public class AccountTests
    {
        ...
        {
            var entityFactory = new IntegrationTestingSample.Infrastructure.InMemoryDataAccess.EntityFactory();
            //
            // Arrange
